...
The MIDI file is the music by default (it's synthesized through pygame.mixer);
pass --audio to play a produced track instead. The song auto-plays in demo mode
(no MIDI device needed); pass --play to take control with the PC keyboard (lanes
...
def main() -> None:
    ...
    parser.add_argument('--audio', default=None,
                        help='Produced audio track (mp3/ogg/wav) to play instead '
                             'of synthesizing the MIDI itself.')
