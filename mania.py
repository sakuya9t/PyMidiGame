...
by name (SONG.mid -> SONG.ogg/.mp3/.wav/.flac in the same folder), else the MIDI
itself synthesized through pygame.mixer. The song auto-plays in demo mode (no
...
def main() -> None:
    ...
    parser.add_argument('--audio', default=None,
                        help='Produced audio track (mp3/ogg/wav) to play. '
                             'Overrides the paired-file / MIDI-synthesis fallback.')
